...
require 'r3ripper/disc/scanDiscCdparanoia'
...
describe ScanDiscCdparanoia do
  ...
  context "Before scanning any disc" do
    ...
    it "should raise an error when a function other than scan() is called" do
      ...
      expect{disc.getLengthSector(1)}.to raise_error(RuntimeError, /getLengthSector/)
      expect{disc.getLengthText(1)}.to raise_error(RuntimeError, /getLengthText/)
      expect{disc.getFileSize(1)}.to raise_error(RuntimeError, /getFileSize/)
      expect{disc.getStartSector('image')}.to raise_error(RuntimeError, /getStartSector/)
      expect{disc.getLengthSector('image')}.to raise_error(RuntimeError, /getLengthSector/)
      expect{disc.getLengthText('image')}.to raise_error(RuntimeError, /getLengthText/)
      expect{disc.getFileSize('image')}.to raise_error(RuntimeError, /getFileSize/)
    end
  end
