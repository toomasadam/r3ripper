...
# The main program is launched from the class R3ripper
class R3ripper
  include GetText
  GetText.bindtextdomain("r3ripper")
  ...
  def checkConfiguration
    require 'r3ripper/fileScheme'
    @fileScheme = FileScheme.new(@disc, @trackSelection)
    @fileScheme.prepare()
    
    require 'r3ripper/checkConfigBeforeRipping'
