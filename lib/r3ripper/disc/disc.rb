...
require 'r3ripper/disc/calcFreedbID'
require 'r3ripper/disc/calcMusicbrainzID'
...
attr_reader :metadata
  ...
  def advancedTocScanner(cdinfo=nil, cdcontrol=nil)
    ...
    if @deps.installed?('cd-info')
      require 'r3ripper/disc/scanDiscCdinfo'
      cdinfo ? cdinfo : ScanDiscCdinfo.new()
    elsif @deps.installed?('cdcontrol')
      require 'r3ripper/disc/scanDiscCdcontrol'
  ...
  def startExtendedTocScan()
    require 'r3ripper/disc/scanDiscCdrdao'
  ...
  def getCuesheet(codec, fileScheme)
    require 'r3ripper/disc/cuesheet'
  ...
  def setMetadata(metadata=nil)
    require 'r3ripper/metadata/main'
